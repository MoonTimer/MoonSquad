...
public class EntityFishHook extends Entity {
    ...
    public void handleHookCasting(double p_146035_1_, double p_146035_3_, double p_146035_5_, float p_146035_7_, float p_146035_8_) {
        ...
        p_146035_1_ = p_146035_1_ + this.rand.nextGaussian() * (double) 0.0075F * (double) p_146035_8_;
        p_146035_3_ = p_146035_3_ + this.rand.nextGaussian() * (double) 0.0075F * (double) p_146035_8_;
        p_146035_5_ = p_146035_5_ + this.rand.nextGaussian() * (double) 0.0075F * (double) p_146035_8_;
        ...
        this.prevRotationYaw = this.rotationYaw = (float) (MathHelper.atan2(p_146035_1_, p_146035_5_) * 180.0D / (double) (float) Math.PI);
        this.prevRotationPitch = this.rotationPitch = (float) (MathHelper.atan2(p_146035_3_, f1) * 180.0D / (double) (float) Math.PI);
    ...
    public void onUpdate() {
        ...
        if (this.fishPosRotationIncrements > 0) {
            ...
            if (!this.inGround) {
                ...
                for (this.rotationPitch = (float) (MathHelper.atan2(this.motionY, f5) * 180.0D / (double) (float) Math.PI); this.rotationPitch - this.prevRotationPitch < -180.0F; this.prevRotationPitch -= 360.0F) {
                }
                ...
                if (!this.worldObj.isRemote && d10 > 0.0D) {
                    ...
                    if (this.ticksCatchable > 0) {
                        ...
                        if (this.ticksCatchableDelay <= 0) {
                            ...
                            worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, this.posX, f8 + 1.0F, this.posZ, (int) (1.0F + this.width * 20.0F), this.width, 0.0D, this.width, 0.2F);
                            worldserver.spawnParticle(EnumParticleTypes.WATER_WAKE, this.posX, f8 + 1.0F, this.posZ, (int) (1.0F + this.width * 20.0F), this.width, 0.0D, this.width, 0.2F);
                            this.ticksCatchable = MathHelper.getRandomIntegerInRange(this.rand, 10, 30);
                        } else {
                            this.fishApproachAngle = (float) ((double) this.fishApproachAngle + this.rand.nextGaussian() * 4.0D);
                            float f7 = this.fishApproachAngle * ((float) Math.PI / 180F);
                            ...
                            if (block1 == Blocks.water || block1 == Blocks.flowing_water) {
                                if (this.rand.nextFloat() < 0.15F) {
                                    worldserver.spawnParticle(EnumParticleTypes.WATER_BUBBLE, d13, d15 - (double) 0.1F, d16, 1, f10, 0.1D, f11, 0.0D);
                                }
                        ...
                        if (this.rand.nextFloat() < f1) {
                            float f9 = MathHelper.randomFloatClamp(this.rand, 0.0F, 360.0F) * ((float) Math.PI / 180F);
                            float f2 = MathHelper.randomFloatClamp(this.rand, 25.0F, 60.0F);
                            double d12 = this.posX + (double) (MathHelper.sin(f9) * f2 * 0.1F);
                            double d14 = (float) MathHelper.floor_double(this.getEntityBoundingBox().minY) + 1.0F;
                            ...
                            if (block == Blocks.water || block == Blocks.flowing_water) {
                                worldserver.spawnParticle(EnumParticleTypes.WATER_SPLASH, d12, d14, d6, 2 + this.rand.nextInt(2), 0.1F, 0.0D, 0.1F, 0.0D);
                            }
                        }
