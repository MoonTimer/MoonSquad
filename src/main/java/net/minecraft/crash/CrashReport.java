...
public class CrashReport {
    ...
    public CrashReport(final String descriptionIn, final Throwable causeThrowable) {
        super();
        this.theReportCategory = new CrashReportCategory("System Details");
    ...
    private void populateEnvironment() {
        ...
        if (Reflector.FMLCommonHandler_enhanceCrashReport.exists()) {
            final Object instance = Reflector.call(Reflector.FMLCommonHandler_instance);
    ...
    public CrashReportCategory makeCategoryDepth(final String categoryName, final int stacktraceLength) {
        final CrashReportCategory crashreportcategory = new CrashReportCategory(categoryName);
