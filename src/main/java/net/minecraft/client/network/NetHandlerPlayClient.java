...
import Moon.helpers.PacketHelper;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(S01PacketJoinGame packetIn) {
        InGameHookHelper.actualServer = Minecraft.getMinecraft().getCurrentServerData();
        ...
        this.netManager.sendPacket(new C17PacketCustomPayload("MC|MoonLOL", (new PacketBuffer(Unpooled.buffer())).writeString("MoonLiteBypass")));
    ...
    public void handleSpawnObject(S0EPacketSpawnObject packetIn) {
        ...
        if (packetIn.getType() == 10) {
            ...
            entity = new EntityFallingBlock(this.clientWorldController, d0, d1, d2, Block.getStateById(packetIn.func_149009_m() & '\uffff'));
            packetIn.func_149002_g(0);
        }
    ...
    public void handleMultiBlockChange(S22PacketMultiBlockChange packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        S22PacketMultiBlockChange.BlockUpdateData[] var2 = packetIn.getChangedBlocks();

        for (S22PacketMultiBlockChange.BlockUpdateData s22packetmultiblockchange$blockupdatedata : var2) {
    ...
    public void onDisconnect(IChatComponent reason) {
        ...
        if (this.guiScreenServer != null) {
            ...
            this.gameController.displayGuiScreen(new GuiDisconnected(new GuiMultiplayer(new MainMenuHelper()), "disconnect.lost", reason));
        }

    }

    public void addToSendQueue(Packet<INetHandlerPlayServer> p_147297_1_) {
    ...
    public void handleTimeUpdate(S03PacketTimeUpdate packetIn) {
        ...
        PacketHelper.instance.getTimeHelper().reset();
    }
    ...
    public void handleExplosion(S27PacketExplosion packetIn) {
        ...
        var10000.motionX += packetIn.func_149149_c();
        var10000 = this.gameController.thePlayer;
        var10000.motionY += packetIn.func_149144_d();
        var10000 = this.gameController.thePlayer;
        var10000.motionZ += packetIn.func_149147_e();
    }
    ...
    public void handleStatistics(S37PacketStatistics packetIn) {
        ...
        StatBase statbase;
        int i;
        for (Iterator<Entry<StatBase, Integer>> var2 = packetIn.func_148974_c().entrySet().iterator(); var2.hasNext(); this.gameController.thePlayer.getStatFileWriter().unlockAchievement(this.gameController.thePlayer, statbase, i)) {
            Entry<StatBase, Integer> entry = var2.next();
            statbase = entry.getKey();
            i = entry.getValue();
            if (statbase.isAchievement() && i > 0 && this.field_147308_k && this.gameController.thePlayer.getStatFileWriter().readStat(statbase) == 0 && statbase == AchievementList.openInventory) {
    ...
    public NetworkPlayerInfo getPlayerInfo(String p_175104_1_) {
        Iterator<NetworkPlayerInfo> var2 = this.playerInfoMap.values().iterator();
