...
import Moon.Moon;
import Moon.helpers.LicenseHelper;
import Moon.helpers.MainMenuHelper;
import Moon.helpers.PacketHelper;
import Moon.mods.crashitems.TabArmor;
import Moon.mods.crashitems.TabExploits;
import Moon.mods.crashitems.TabSword;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        this.checkGLError();
        this.ingameGUI = new InGameHookHelper(this);
    ...
    private void runGameLoop() throws IOException {
        ...
        synchronized (this.scheduledTasks) {
            while (!this.scheduledTasks.isEmpty()) {
                Util.runTask((FutureTask) this.scheduledTasks.poll());
            }
        }
    ...
    private void sendClickBlockToController(boolean leftClick) {
        ...
        if (this.leftClickCounter <= 0 && !this.thePlayer.isUsingItem()) {
            if (leftClick && this.objectMouseOver != null && MovingObjectPosition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                    ...
                    do {
                        do {
                            if (!Keyboard.next()) {
                                ...
                                if (this.gameSettings.keyBindUseItem.isKeyDown() && rightClickDelayTimer == 0 && !this.thePlayer.isUsingItem()) {
                                    this.rightClickMouse();
                                }
    ...
    private void middleClickMouse() {
        if (this.objectMouseOver != null) {
            ...
            if (MovingObjectPosition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
                ...
                if (MovingObjectPosition.typeOfHit != MovingObjectPosition.MovingObjectType.ENTITY || this.objectMouseOver.entityHit == null || !flag) {
                    return;
                }
