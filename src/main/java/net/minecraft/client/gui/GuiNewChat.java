...
public class GuiNewChat extends Gui {
    ...
    public void drawChat(int p_146230_1_) {
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (k > 0) {
                ...
                MathHelper.ceiling_float_int((float) this.getChatWidth() / f1);
                GlStateManager.pushMatrix();
                GlStateManager.translate(2.0F, 5.0F, 0.0F);
                GlStateManager.scale(f1, f1, 1.0F);

                int i1;
                int j1;
                int l1;
                for (i1 = 0; i1 + this.scrollPos < this.field_146253_i.size() && i1 < i; ++i1) {
    ...
    private void setChatLine(IChatComponent p_146237_1_, int p_146237_2_, int p_146237_3_, boolean p_146237_4_) {
        ...
        List<IChatComponent> list = GuiUtilRenderComponents.splitText(p_146237_1_, i, this.mc.fontRendererObj, false, false);
        boolean flag = this.getChatOpen();

        IChatComponent ichatcomponent;
        for (Iterator<IChatComponent> var8 = list.iterator(); var8.hasNext(); this.field_146253_i.add(0, new ChatLine(p_146237_3_, ichatcomponent, p_146237_2_))) {
            ichatcomponent = var8.next();
