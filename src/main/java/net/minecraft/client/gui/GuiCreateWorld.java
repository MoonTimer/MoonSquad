...
public class GuiCreateWorld extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(this.fontRendererObj, I18n.format("selectWorld.create"), width / 2, 20, -1);

        if (this.inMoreWorldOptionsDisplay) {
            drawString(this.fontRendererObj, I18n.format("selectWorld.enterSeed"), width / 2 - 100, 47, -6250336);
            drawString(this.fontRendererObj, I18n.format("selectWorld.seedInfo"), width / 2 - 100, 85, -6250336);

            if (this.btnMapFeatures.visible) {
                drawString(this.fontRendererObj, I18n.format("selectWorld.mapFeatures.info"), width / 2 - 150, 122, -6250336);
            }

            if (this.btnAllowCommands.visible) {
                drawString(this.fontRendererObj, I18n.format("selectWorld.allowCommands.info"), width / 2 - 150, 172, -6250336);
            }
            ...
            drawString(this.fontRendererObj, I18n.format("selectWorld.enterName"), width / 2 - 100, 47, -6250336);
            drawString(this.fontRendererObj, I18n.format("selectWorld.resultFolder") + " " + this.saveDirName, width / 2 - 100, 85, -6250336);
            this.worldNameField.drawTextBox();
            drawString(this.fontRendererObj, this.gameModeDesc1, width / 2 - 100, 137, -6250336);
            drawString(this.fontRendererObj, this.gameModeDesc2, width / 2 - 100, 149, -6250336);
        }
