...
public class GuiScreenAddServer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.fontRendererObj, I18n.format("addServer.enterName"), width / 2 - 100, 53, 10526880);
        drawString(this.fontRendererObj, I18n.format("addServer.enterIp"), width / 2 - 100, 94, 10526880);
