...
public class GuiDisconnected extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, width / 2 - 100, height / 2 + this.field_175353_i / 2 + this.fontRendererObj.FONT_HEIGHT + 25, I18n.format("gui.toMenu")));
        this.buttonList.add(new GuiButton(1, width / 2 - 100, height / 2 + this.field_175353_i / 2 + this.fontRendererObj.FONT_HEIGHT, "Reconnect"));
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 0) {
            ...
            ServerData serverData = InGameHookHelper.actualServer;
