...
import Moon.Moon;
import Moon.helpers.PCHelper;
import Moon.mods.grief.PortScanner;
import Moon.mods.grief.UUIDSpoofer;
...
import net.minecraft.viamcp.gui.GuiProtocolSelector;
...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
    ...
    public void createButtons() {
        ...
        this.buttonList.add(new GuiButton(100, 100, 5, 90, 20, "UUID Spoofer"));
        this.buttonList.add(new GuiButton(111, 195, 5, 90, 20, "Port Scanner"));
