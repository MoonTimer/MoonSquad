...
public class GuiCommandBlock extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawString(this.fontRendererObj, I18n.format("advMode.command"), width / 2 - 150, 37, 10526880);
        this.commandTextField.drawTextBox();
        int i = 75;
        int j = 0;
        drawString(this.fontRendererObj, I18n.format("advMode.nearestPlayer"), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        drawString(this.fontRendererObj, I18n.format("advMode.randomPlayer"), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        drawString(this.fontRendererObj, I18n.format("advMode.allPlayers"), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        drawString(this.fontRendererObj, I18n.format("advMode.allEntities"), width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);
        drawString(this.fontRendererObj, "", width / 2 - 150, i + j++ * this.fontRendererObj.FONT_HEIGHT, 10526880);

        if (this.previousOutputTextField.getText().length() > 0) {
            i = i + j * this.fontRendererObj.FONT_HEIGHT + 16;
            drawString(this.fontRendererObj, I18n.format("advMode.previousOutput"), width / 2 - 150, i, 10526880);
