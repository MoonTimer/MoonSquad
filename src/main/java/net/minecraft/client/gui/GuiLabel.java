...
public class GuiLabel extends Gui {
        ...
        if (this.visible) {
            ...
            for (int k = 0; k < this.field_146173_k.size(); ++k) {
                if (this.centered) {
                    ...
                    drawString(this.fontRenderer, this.field_146173_k.get(k), this.field_146162_g, j + k * 10, this.field_146168_n);
                }
            }
        }
    }
    ...
    protected void drawLabelBackground(Minecraft mcIn, int p_146160_2_, int p_146160_3_) {
        if (this.labelBgEnabled) {
            ...
            drawHorizontalLine(k, k + i, l, this.field_146166_p);
            drawHorizontalLine(k, k + i, l + j, this.field_146165_q);
            drawVerticalLine(k, l, l + j, this.field_146166_p);
            drawVerticalLine(k + i, l, l + j, this.field_146165_q);
        }
    }
}
