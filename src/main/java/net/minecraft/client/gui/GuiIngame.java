...
import Moon.helpers.OpenGLHelper;
...
public class GuiIngame extends Gui {
    ...
    public void renderExpBar(ScaledResolution scaledRes, int x) {
        ...
        if (i > 0) {
            ...
            l1 = scaledRes.getScaledHeight() - 32 + 3;
            this.drawTexturedModalRect(x, l1, 0, 64, j, 5);
            if (k > 0) {
                this.drawTexturedModalRect(x, l1, 0, 69, k, 5);
            }
        }
        ...
        if (this.mc.thePlayer.experienceLevel > 0) {
            ...
            l1 = (scaledRes.getScaledWidth() - this.getFontRenderer().getStringWidth(s)) / 2;
    ...
    protected boolean showCrosshair() {
        if (GameSettings.showDebugInfo && !this.mc.thePlayer.hasReducedDebug() && !this.mc.gameSettings.reducedDebugInfo) {
            return false;
        } else if (this.mc.playerController.isSpectator()) {
            if (this.mc.pointedEntity != null) {
                return true;
            } else if (this.mc.objectMouseOver != null && MovingObjectPosition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
    ...
    private void renderHotbar() {
        ...
        OpenGLHelper.drawRect(0.0F, (sr.getScaledHeight() - 23), sr.getScaledWidth(), sr.getScaledHeight(), -2147483648);
        if (this.mc.thePlayer.inventory.currentItem == 0) {
            OpenGLHelper.drawRect((sr.getScaledWidth() / 2 - 91 + this.mc.thePlayer.inventory.currentItem * 20), (sr.getScaledHeight() - 21), (sr.getScaledWidth() / 2 + 91 - 160), sr.getScaledHeight(), 2147483647);
        } else {
            OpenGLHelper.drawRect((sr.getScaledWidth() / 2 - 91 + this.mc.thePlayer.inventory.currentItem * 20), (sr.getScaledHeight() - 21), (sr.getScaledWidth() / 2 + 91 - 20 * (8 - this.mc.thePlayer.inventory.currentItem)), sr.getScaledHeight(), 2147483647);
        }
        mc.fontRendererObj.drawStringWithShadow(ChatHelper.fix("&4&lX, Y, Z&8: &f"), 1, sr.getScaledHeight() - 11, 16777215);
        mc.fontRendererObj.drawStringWithShadow(" " + Math.round(this.mc.thePlayer.posX) + ", " + Math.round(this.mc.thePlayer.posY) + ", " + Math.round(this.mc.thePlayer.posZ), 35, sr.getScaledHeight() - 11, 16777215);
        mc.fontRendererObj.drawStringWithShadow(ChatHelper.fix("&4&lNICK&8: &f"), 1, sr.getScaledHeight() - 21, 16777215);
        mc.fontRendererObj.drawStringWithShadow(" " + Minecraft.getMinecraft().getSession().getUsername(), 35, sr.getScaledHeight() - 21, 16777215);
        ...
        mc.fontRendererObj.drawStringWithShadow(ChatHelper.fix("&4&lDATE&8: &f"), sr.getScaledWidth() - 91, sr.getScaledHeight() - 20, 16777215);
        mc.fontRendererObj.drawStringWithShadow(renderDate, sr.getScaledWidth() - 60, sr.getScaledHeight() - 21, 16777215);
        mc.fontRendererObj.drawStringWithShadow(ChatHelper.fix("&4&lUHR&8: &f"), sr.getScaledWidth() - 91, sr.getScaledHeight() - 10, 16777215);
        mc.fontRendererObj.drawStringWithShadow(renderTime, sr.getScaledWidth() - 60, sr.getScaledHeight() - 11, 16777215);
    }
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer) {
            ...
            for (i6 = 0; i6 < 10; ++i6) {
                if (k2 > 0) {
                    j6 = i1 + i6 * 8;
                    if (i6 * 2 + 1 < k2) {
                        this.drawTexturedModalRect(j6, j2, 34, 9, 9, 9);
                    }

                    if (i6 * 2 + 1 == k2) {
                        this.drawTexturedModalRect(j6, j2, 25, 9, 9, 9);
                    }

                    if (i6 * 2 + 1 > k2) {
                        this.drawTexturedModalRect(j6, j2, 16, 9, 9, 9);
                    }
                }
            }
            ...
            if (entity == null) {
                ...
                for (j6 = 0; j6 < 10; ++j6) {
                    ...
                    j4 = j1 - j6 * 8 - 9;
                    this.drawTexturedModalRect(j4, i7, 16 + k8 * 9, 27, 9, 9);
                    if (j6 * 2 + 1 < k) {
                        this.drawTexturedModalRect(j4, i7, l7 + 36, 27, 9, 9);
                    }

                    if (j6 * 2 + 1 == k) {
                        this.drawTexturedModalRect(j4, i7, l7 + 45, 27, 9, 9);
                    }
                }
            } else if (entity instanceof EntityLivingBase) {
                this.mc.mcProfiler.endStartSection("mountHealth");
                EntityLivingBase entitylivingbase = (EntityLivingBase) entity;
                i7 = (int) Math.ceil(entitylivingbase.getHealth());
                ...
                for (int k9 = 0; i4 > 0; k9 += 20) {
                    ...
                    for (int i5 = 0; i5 < l4; ++i5) {
                        int j5 = 52;
                        int l5 = j1 - i5 * 8 - 9;
                        this.drawTexturedModalRect(l5, j4, j5, 9, 9, 9);
                        if (i5 * 2 + 1 + k9 < i7) {
                            this.drawTexturedModalRect(l5, j4, j5 + 36, 9, 9, 9);
                        }

                        if (i5 * 2 + 1 + k9 == i7) {
                            this.drawTexturedModalRect(l5, j4, j5 + 45, 9, 9, 9);
                        }
                    }
            ...
            if (entityplayer.isInsideOfMaterial(Material.water)) {
                ...
                i7 = MathHelper.ceiling_double_int((double) (j6 - 2) * 10.0D / 300.0D);
                l7 = MathHelper.ceiling_double_int((double) j6 * 10.0D / 300.0D) - i7;

                for (i4 = 0; i4 < i7 + l7; ++i4) {
                    if (i4 < i7) {
                        this.drawTexturedModalRect(j1 - i4 * 8 - 9, j2, 16, 18, 9, 9);
                    } else {
                        this.drawTexturedModalRect(j1 - i4 * 8 - 9, j2, 25, 18, 9, 9);
                    }
                }
            }
