...
public class GuiConnecting extends GuiScreen {
    ...
    public GuiConnecting(GuiScreen p_i1181_1_, Minecraft mcIn, ServerData p_i1181_3_) {
        ...
        InGameHookHelper.actualServer = p_i1181_3_;
        mcIn.loadWorld(null);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.networkManager == null) {
            drawCenteredString(this.fontRendererObj, I18n.format("connect.connecting"), width / 2, height / 2 - 50, 16777215);
        } else {
            drawCenteredString(this.fontRendererObj, I18n.format("connect.authorizing"), width / 2, height / 2 - 50, 16777215);
        }
