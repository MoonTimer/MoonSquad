...
import net.minecraft.viamcp.loader.VRBackwardsLoader;
import net.minecraft.viamcp.loader.VRProviderLoader;
import net.minecraft.viamcp.loader.VRRewindLoader;
import net.minecraft.viamcp.platform.VRInjector;
import net.minecraft.viamcp.platform.VRPlatform;
