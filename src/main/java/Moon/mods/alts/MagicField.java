...
public class MagicField extends Gui {
    ...
    private final int maxStringLength = 95;
    ...
    public MagicField(FontRenderer par1FontRenderer, int par2, int par3, int par4, int par5) {
    ...
    public int getNthWordFromCursor(int par1) {
        return this.getNthWordFromPos(par1);
    }
    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            int var1 = this.isEnabled ? enabledColor : disabledColor;
