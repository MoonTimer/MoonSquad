        ...
        while (true) {
            ...
            if (alt2 == this.selectedAlt) {
                if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
                    OpenGLHelper.INSTANCE.drawBorderedRect(52.0F, (float) (y2 - this.offset - 4), (float) (width - 52), (float) (y2 - this.offset + 20), 1.0F, -16777216, -2142943931);
                } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                    OpenGLHelper.INSTANCE.drawBorderedRect(52.0F, (float) (y2 - this.offset - 4), (float) (width - 52), (float) (y2 - this.offset + 20), 1.0F, -16777216, -2142088622);
                } else {
                    OpenGLHelper.INSTANCE.drawBorderedRect(52.0F, (float) (y2 - this.offset - 4), (float) (width - 52), (float) (y2 - this.offset + 20), 1.0F, -16777216, -2144259791);
                }
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset) && Mouse.isButtonDown(0)) {
                OpenGLHelper.INSTANCE.drawBorderedRect(52.0F, (float) (y2 - this.offset - 4), (float) (width - 52), (float) (y2 - this.offset + 20), 1.0F, -16777216, -2146101995);
            } else if (this.isMouseOverAlt(par1, par2, y2 - this.offset)) {
                OpenGLHelper.INSTANCE.drawBorderedRect(52.0F, (float) (y2 - this.offset - 4), (float) (width - 52), (float) (y2 - this.offset + 20), 1.0F, -16777216, -2145180893);
            }
