...
import Moon.utils.font.UnicodeFontRenderer;
...
//        if (mods.size() == 0) {
        mods.clear();
        for (Module module : Moon.INSTANCE.moduleManager.modules) {
...
//        }
        ...
        FontLoaders.arial24.drawString(Moon.CLIENT_NAME, x + 18, y + 15, mainColor.getRGB());

        UnicodeFontRenderer cateFont = Moon.fontLoaders.msFont18;
